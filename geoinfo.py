...
print('<<')
print(' NGROK Organization նորաբաց հայկական IT կազմակերպությունը, որը տվյալ տարածաշրջանում առաջիններից է արհեստական բանականության ոլորտում, մասնակցում է 4-րդ միջազգային "Թեքնովեյշն" IT մրցույթին:')
print(' Առաջարկում ենք գնահատել մեր ծրագիրը, որը աշխատում է բոլոր պլատֆորմաների վրա (ios, android,  windows և այլն)')
print(' Պրոեկտի ստեղծման նպատակը միայնակ մարդկանց օգնելն է նոր ծանոթությնուններ գտնելու հարցում, օգտագործելով նորարար տեխնոլոգիաներ, այդ թվում նաև մեքենայական ավտոմատացված ուսուցում և այլն:')
print(' Ծրագիրը կարողանում է.')
print(' •ավտոմատ կերպով կազմել Ձեր հետաքրքրությունների ընդհանուր բնութագիրը')
print(' •համապատասխան ալգորիթմի օգնությամբ գտնել Ձեզ համապատասխան մարդուն Ձեր իսկ տարածաշրջանից օգտագործելով Ձեր գեոլոկացիոն տվյալները:')
print(' հ.գ. Էջը գտնվում է պատրաստման շրջանում, այդ պատճառով հղումը ունի այսպիսի տեսք')
print('>>')
row = []
info = 'php/info.txt'
